...
class PyDevRemoteDebugWidget:
    ...
    def isValidPydevdDir(self, pydevDir):
        try:
    ...
    def getPydevdDir(self):
        ...
        if not pydevdDir:
            candidatePydevdDirs=[]
            candidatePydevdDirs.append("/Applications/PyCharm.app/Contents/debug-eggs/pycharm-debug.egg")
            # candidatePydevdDirs.append("/Applications/eclipse/plugins/org.python.pydev_3.9.2.201502050007/pysrc/")
